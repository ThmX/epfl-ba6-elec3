...
\todo[inline]{UC implémentation en VHDL}

\todo[inline]{HORLOGE description des choix et fonctionnalités}

\todo[inline]{HORLOGE implémentation en VHDL}
...
\todo[inline]{implémentation en Java}
